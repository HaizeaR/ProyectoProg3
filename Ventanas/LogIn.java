...
public class LogIn extends JFrame {
	...
	JLabel lCorreo, lContraseÒa,lLogin,lPelicula, lSala, lHora, lAsiento; 
	JTextField tfCorreo; 
	...
	public LogIn() {
		...
		// Definir m√°s adelante 
		// tenemos que meter en un panel la informaci√≥n de compra
		// fecha, hora , asientos ... 
		...
		lContraseÒa = new JLabel("ContraseÒa :");
		
		tfCorreo = new JTextField(10); 
		jpContraseÒa = new JPasswordField(10);
	
		
		pCentral.add(lCorreo);
		pCentral.add(tfCorreo);
		
		pCentral.add(lContraseÒa);
		pCentral.add(jpContraseÒa); 
	...
	/** M√©todo que contiene el hilo que nos permite
...
//			ps.close();
//		} catch (Exception e) {
//			JOptionPane.showMessageDialog( null, "Error en creaci√≥n de fichero config.txt", "Error de configuraci√≥n", JOptionPane.ERROR_MESSAGE );
//		}
//	}
//
//
