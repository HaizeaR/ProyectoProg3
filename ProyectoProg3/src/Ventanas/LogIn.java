...
public class LogIn extends JFrame {
	...
	public LogIn() {
		...
		// Definir mÃ¡s adelante 
		// tenemos que meter en un panel la informaciÃ³n de compra
		// fecha, hora , asientos ... 
	...
	/** MÃ©todo que contiene el hilo que nos permite
...
//			ps.close();
//		} catch (Exception e) {
//			JOptionPane.showMessageDialog( null, "Error en creaciÃ³n de fichero config.txt", "Error de configuraciÃ³n", JOptionPane.ERROR_MESSAGE );
//		}
//	}
//
//
